<%-- 
    ...
    Created on : 01/12/2018, 02:21:58
    Author     : verss
--%>
...
<html>
	...
	%>
        ...
        <form class="ui form" style="width: 80%; margin-left: 10%; margin-top: 40px; margin-bottom: 100px;" action="../SalvarEndereco"  method="POST">
            <h2 class="ui dividing header">Cadastro de Endereço</h2>
            <div class="four fields">
                ...
                <div class="field">
                    <label>Numero</label>
                    <input type="text" name="txtNumeroEndereco" id="txtNumeroEndereco" placeholder="Número">
                </div>
                <div class="field">
